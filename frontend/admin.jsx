...
const AdminDashboard = () => {
  ...
  // Unique game names for the block dropdown
      ...
      <div className="dashboard-content">
        ...
        <div className="admin-profile-card">
          ...
          <div className="admin-info">
            <h3>Admin Profile</h3>
            <p>
              <strong>Name:</strong> Khushi Poddar &amp; Muskan Poddar
            </p>
            <p>
              <strong>Email:</strong> admin@joyjuncture.com
            </p>
            <p>
        ...
        <div className="management-grid">
          ...
          <div className="dashboard-column">
            ...
            >
              <div className="input-group">
                ...
                <button className="btn-action" onClick={handleAddGame}>
                  + Add to List
                </button>
              </div>
          ...
          <div className="dashboard-column">
            ...
            <div className="logic-note">
              ...
              <u>block</u> that venue for any other function requests.
            </div>
          </div>
        </div>
      </div>
